  ...
  return (
    <section className="relative overflow-hidden bg-navy-950 pb-28 pt-16 sm:pb-32 sm:pt-20">
      ...
      <Container className="relative flex flex-col items-center text-center">
        ...
        >
          Rentico manages short-term rentals across Dubai and Abu Dhabi. You refer the owner, we run the property,
          and you earn a commission on every unit that goes live — without giving up the relationship.
        </motion.p>
        ...
        <motion.div
          ...
          className="mt-12 grid w-full grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4"
        >
          {stats.map((s) => (
            <div
              key={s.value}
