...
const details = [
  { icon: MapPin, label: "1604 The One Tower, Dubai, UAE" },
  { icon: Phone, label: "+971-52 146 0222", href: "tel:+971521460222" },
  { icon: Mail, label: "info@renticodubai.com", href: "mailto:info@renticodubai.com" },
  { icon: Clock, label: "Our team typically responds within 24 hours" },
];
